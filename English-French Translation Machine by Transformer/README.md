In this work, I build the Translation Machine from English to French by Transformer in the paper ["Atttention Is All You Need"](https://arxiv.org/abs/1706.03762).
